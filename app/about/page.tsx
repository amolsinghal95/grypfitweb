...
const timeline = [
  ...
  { year: "2025", event: "Launched GRYP.FIT brand" },
];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h1 className="text-5xl font-bold mb-4">
            About <span className="text-primary">GRYP.FIT</span>
          </h1>
        ...
        <section className="mb-20">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="bg-secondary border border-muted rounded-lg p-8 md:p-12"
          >
            <h2 className="text-3xl font-bold mb-6 text-primary">Who We Are</h2>
            <p className="text-muted text-lg leading-relaxed mb-4">
              Singhal Industries, operating under the brand name GRYP.FIT, is a trusted manufacturer 
                ...
                {timeline.map((item, index) => (
                  ...
                  >
                    <div className={`md:w-1/2 ${index % 2 === 0 ? "md:text-right" : "md:text-left"} text-center`}>
                      <div className="bg-secondary border border-muted rounded-lg p-6">
        ...
        <section>
          ...
          >
            <h2 className="text-3xl font-bold mb-8 text-center">Why Choose GRYP.FIT?</h2>

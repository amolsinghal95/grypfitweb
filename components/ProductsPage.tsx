...
const categories = ["All", "Gym", "Sports", "Plates & Weights"] as const;
...
export default function ProductsPage({
  ...
  return (
    <div className="pt-32">
      ...
      <div className="-mt-10 mb-2 rounded-[2rem] border border-slate-200 bg-slate-50/80 px-6 py-6 md:px-8">
        <p className="text-sm md:text-base font-bold text-primary mb-4">
          Looking for bulk orders or custom manufacturing? Contact us for a quote.
        </p>
        <div className="flex flex-col sm:flex-row gap-3">
          <a
            href="https://wa.me/918449291260?text=Hello! I am looking for bulk orders or custom manufacturing support. Please share details."
            target="_blank"
            rel="noopener noreferrer"
            className="btn-premium btn-primary !px-6 !py-3 text-sm"
          >
            WhatsApp Quote
          </a>
          <Link
